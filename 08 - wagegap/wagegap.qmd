...
head(esp[, c("EARNHR", "asalariado")], n = 10)  |> 
  tt(width = 0.6) |> 
  style_tt(j = 1, width = 6, align = "r")  |> 
  style_tt(j = 2, width = 12, align = "c")
```
...
\begin{aligned}
  \mathit{lsalario} =\, &\beta_0 
    ...
    + u 
\end{aligned}
$$ {#eq-mod2} - ¿Cuál es la interpretación del parámetro $\beta_1$ en el modelo de la @eq-mod2? ¿En qué se diferencia con la interpretación de ese parámetro en la @eq-mod1?
