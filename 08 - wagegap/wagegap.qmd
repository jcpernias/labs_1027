...
::: {.callout-note appearance="simple"}
Contraste la existencia de una brecha salarial en contra de las mujeres.
:::
...
::: {.callout-note appearance="simple"}
¿Cuál es la interpretación del parámetro $\beta_1$ en el modelo de la @eq-mod2? ¿En qué se diferencia las interpretación de ese parámetro en la @eq-mod1 y en la @eq-mod2?
:::
